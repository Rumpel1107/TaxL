...
| # | Question | Tag |
|---|---|---|
| 12 | Define the exact "key lines" that the $0-difference criterion (M1) applies to | `[R]` |
| 13 | Define a measurable North Star Metric for when real users exist | `[R]` |
| 14 | Set the price anchor in COP for tier X, before the M5 probe asks about a concrete number | `[R]` |
