...
9. INCREMENTAL SCOPE: MVP automates one reference case (salaried employee, cedula general) with out-of-scope detection. Coverage expands case by case as real scenarios appear, never speculatively.
